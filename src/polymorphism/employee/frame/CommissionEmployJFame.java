...
public class CommissionEmployJFame extends EmployeeBaseJFrame{
...
//			}
//		});
		employeeType = "Commission Emplyee (by RyanZa107230001)";
		CommissionEmployJFame component = new CommissionEmployJFame(employeeType);
		
		Main_Run(component, employeeType, new BtnController4SuperEmployeeBase(component,null));
	}
	public CommissionEmployJFame(String employeeType) {
		super(employeeType);
		employeeType4Jframe="Commission Employee(by a0001 zhang)";
...
public EmployeeBaseJFrame refreshJFrame() {
	...
	btnController = new BtnController4SuperEmployeeBase(component,null);
