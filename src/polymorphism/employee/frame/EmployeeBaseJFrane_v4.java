...
public class EmployeeBaseJFrane_v4 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrane_v4 frame = new EmployeeBaseJFrane_v4(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrane_v4(String employeeType) {
