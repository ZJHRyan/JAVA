...
public class CommissionEmployJFame_v2 extends EmployeeBaseJFrane_v1 {
	...
	public CommissionEmployJFame_v2(String employeeType) {
		super(employeeType);
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmployJFame_v2 frame = new CommissionEmployJFame_v2(employeeType);
