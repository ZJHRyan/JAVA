...
public class CommissionEmployJFame_v4 extends EmployeeBaseJFrane_v2 {
	...
	public CommissionEmployJFame_v4(String employeeType) {
		super(employeeType);
...
protected void setupComponent4JPanel() 
{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmployJFame_v4 frame = new CommissionEmployJFame_v4(employeeType);
