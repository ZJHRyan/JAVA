...
public class EmployeeBaseJFrane_v2 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrane_v2 frame = new EmployeeBaseJFrane_v2(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrane_v2(String employeeType) {
