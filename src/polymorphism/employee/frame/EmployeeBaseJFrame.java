...
public class EmployeeBaseJFrame extends JInternalFrame /*JFrame*/ {
	public static EmployeeBaseJFrame frame;
...
//	public JButton btnCloseFile;
	...
	public JLabel lblAUpperThreshold;
	...
	public DefaultListModel<Object> listModel1 = new DefaultListModel<Object>();
...
//			Btns4universalProcess_MenuOpAdv.CLoseFiLe,
	...
	public static BtnController4SuperEmployeeBase btnController;
	...
	public boolean ifPreviewing= true;


	public boolean isSimpleFprmat = false;
...
//		});
		...
		EmployeeBaseJFrame frame_real = new EmployeeBaseJFrame(employeeType);
		JOptionPane.showMessageDialog(null, "as");
		Main_Run(frame_real, employeeType, new BtnController4SuperEmployeeBase(frame_real ));
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrame(String employeeType) {
	...
	public EmployeeBaseJFrame(String emoloyeeType,JDesktopPane _DesktopPane) {
		super(emoloyeeType+"_APP",
				true,
				true,
				true,
				true);
		employeeType4Jframe=employeeType + "-APP";
		setupAll();
	...
	public void setupAll() {
		try {
		setUpTileAndBasics4JFrame("employee-book application", employeeType);
...
//		initialize4TitleNamesString4JTable(); 
	...
	public static void Main_Run(EmployeeBaseJFrame component, String _employeeType,
			BtnController4SuperEmployeeBase _btnController){
	...
	public static void run2StartOrRefresh(String _frameTitle, EmployeeBaseJFrame component) { 
	...
	public void setUpTileAndBasics4JFrame(String _frameTitle,String employeeType) {
		setTitle(_frameTitle + employeeType);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100,100,722,821);
	}
...
//		contentPane.add(btnCloseFile);
	...
	{ 
		JButton [] buttonsInitialized={btnCalculate, btnRefresh, btnClearRecord, btnSetProfile, btnClearProfile, btnOutputAll, btnExit, 
				btnOpenFile, btnReadFile, btnPieChartDemo};// btnWriteFile, btnCloseFile,
...
//		contentPane.add(txtField); 
	...
	public EmployeeBaseBook setBasics2StartBookingEmployee() {
		employeeBaseBook = new EmployeeBaseBook();
		return employeeBaseBook;
	}
	
	public EmployeeBaseJFrame refreshJFrame() {
		EmployeeBaseJFrame componet = new EmployeeBaseJFrame(employeeType4Jframe);
		helper4Employee = new Helper4SuperEmployeeBase(componet);
		btnController = new BtnController4SuperEmployeeBase(new EmployeeBaseJFrame(employeeType4Jframe), null);
		return componet;
	}
