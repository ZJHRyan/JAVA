...
public class EmployeeBaseJFrane_v1 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrane_v1 frame = new EmployeeBaseJFrane_v1(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrane_v1(String employeeType) {
