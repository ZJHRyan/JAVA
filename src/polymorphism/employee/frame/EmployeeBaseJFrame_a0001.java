...
public class EmployeeBaseJFrame_a0001 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrame_a0001 frame = new EmployeeBaseJFrame_a0001(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrame_a0001(String employeeType) {
