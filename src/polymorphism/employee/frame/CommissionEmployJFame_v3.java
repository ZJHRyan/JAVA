...
public class CommissionEmployJFame_v3 extends EmployeeBaseJFrane_v2 {
	...
	public CommissionEmployJFame_v3(String employeeType) {
		super(employeeType);
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmployJFame_v3 frame = new CommissionEmployJFame_v3(employeeType);
